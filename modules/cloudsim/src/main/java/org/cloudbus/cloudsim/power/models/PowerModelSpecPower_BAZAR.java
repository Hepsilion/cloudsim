 ...
 * 
 * CPU Intel(R) Core(TM)2 Quad CPU Q6700 @ 2.66GHz and 4GB Ram running with
 * Ubuntu TLS 10.4 (Linux kernel 2.6.32). All energy consumption measures have
 * been done on this host with Plogg wireless electricity meter that allow to
 * see and save the live power consumption.
 * 
 ...
 *         Toulouse, France
 * 
 *         * Please cite: T. Guérout et al., Energy-aware simulation with DVFS,
 *         Simulat. Modell. Pract. Theory (2013),
...
public class PowerModelSpecPower_BAZAR extends PowerModelSpecPowerDVFS {
	 ...
	 */
	double Tab_Power_idle[] = { 82.75, 82.85, 82.95, 83.10, 83.25 };
	...
	public double getPower(double utilization) throws IllegalArgumentException {
		...
		System.out.println("Power computation : frequencyIndex=" + index+ ", power=" + Tab_Power_idle[index] + "/"+ Tab_Power_full[index]);
		System.out.println("Power=(1-" + utilization + ")*" + Tab_Power_idle[index] + "+" + utilization + "*" + Tab_Power_full[index]+"="+ conso);
