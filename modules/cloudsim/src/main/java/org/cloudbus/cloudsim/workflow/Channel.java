 ...
 * It controls sharing of available bandwidth among DataItems. 
 * Relation between Transmission and Channel is the same as Cloudlet and CloudletScheduler, but
 * here we consider only the time shared case, representing a shared channel among different simultaneous DataItem transmissions.
 */
public class Channel {
	...
	public double updateTransmission(double currentTime) {
		...
		this.previousTime = currentTime;//TODO 修正源码错误
	...
	/**
	 * @return list of DataItems whose transmission finished, or empty list if no dataItem arrived.
	 */
