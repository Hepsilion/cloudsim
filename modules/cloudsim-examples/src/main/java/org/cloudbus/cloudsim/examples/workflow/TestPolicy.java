...
import org.cloudbus.cloudsim.workflow.DataItem;
import org.cloudbus.cloudsim.workflow.Policy;
import org.cloudbus.cloudsim.workflow.Task;
import org.cloudbus.cloudsim.workflow.VMOffers;

/**
 * A class to test basic policy's functionalities such as reading of the XML file. 
 * This class is NOT intended to be used in actual simulations.
 */
public class TestPolicy extends Policy {
	...
	public static void main(String[] args) {
		...
		String dagFile = "E:/Workspace/Github/cloudsim/modules/dax/Sipht_30.xml";
	...
	private void taskCompleted(int taskId) {
		...
		if (!found)
			System.out.println("Warning: task#" + taskId + " not found");
	}
